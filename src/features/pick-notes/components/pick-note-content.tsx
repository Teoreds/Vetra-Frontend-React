...
export function PickNoteContent({ pickNote }: PickNoteContentProps) {
  ...
  const hasAddresses = shippingLoc || billingLoc;
      ...
      <div className="w-72 shrink-0 space-y-4">
        ...
        {hasAddresses && (
          <Card>
            ...
            <CardContent className="space-y-3">
              {shippingLoc && <Field label="Spedizione" value={fmtLoc(shippingLoc)} />}
              {shippingLoc && billingLoc && <div className="border-t border-border/40 pt-3" />}
              {billingLoc && <Field label="Fatturazione" value={fmtLoc(billingLoc)} />}
            </CardContent>
          </Card>
        )}
