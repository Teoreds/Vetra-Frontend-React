      ...
      <form onSubmit={handleSubmit(onSubmit)} className="space-y-4">
        <div className="grid grid-cols-2 gap-4">
          ...
          <div className="space-y-1.5">
            ...
            {errors.year && (
              <p className="text-[11px] text-danger-foreground">{errors.year.message}</p>
            )}
          </div>
        </div>
        ...
        <div className="space-y-1.5">
          ...
          />
          {errors.max_amount && (
            <p className="text-[11px] text-danger-foreground">{errors.max_amount.message}</p>
          )}
        </div>
        ...
        <div className="grid grid-cols-2 gap-4">
          <div className="space-y-1.5">
            ...
            {errors.valid_from && (
              <p className="text-[11px] text-danger-foreground">{errors.valid_from.message}</p>
            )}
          </div>
          <div className="space-y-1.5">
            ...
            {errors.valid_to && (
              <p className="text-[11px] text-danger-foreground">{errors.valid_to.message}</p>
            )}
          </div>
        </div>
